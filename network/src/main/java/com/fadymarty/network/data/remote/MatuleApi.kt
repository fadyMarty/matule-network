...
import com.fadymarty.network.data.remote.dto.ProductItemDto
...
import com.fadymarty.network.data.remote.dto.requests.RegisterRequest
...
interface MatuleApi {
    ...
    suspend fun getCatalog(): PocketbaseResponseDto<ProductItemDto>

    // Поиск
    @GET("/collections/products/records")
    suspend fun searchProducts(
        @Query("filter") filter: String,
    ): PocketbaseResponseDto<ProductItemDto>
